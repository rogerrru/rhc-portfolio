...
export const Home = () => {
    ...
    // Map JSON img strings to actual imports
    const imageMap = {
        "bg-1.svg": bg1,
        "bg-2.svg": bg2,
        "bg-3.svg": bg3,
    ...
    // Replace img path in JSON with imported asset
    const projectsWithImages = projectsData.map((project) => ({
        ...project,
        img: imageMap[project.img.split("/").pop()],
    }));

    // Pick featured projects for Home (e.g., first 4)
    const featuredProjects = projectsWithImages.slice(0, 4);
                ...
                <section className="max-w-7xl mx-auto md:px-12 md:py-16">
                    ...
                    <div className="grid md:grid-cols-2 md:gap-12 items-center">
                        ...
                        <img
                            src={rectangle1}
                            alt="Portrait"
                            className="w-full max-w-sm rounded-lg shadow-md mx-auto mb-4 md:mb-0"
                        />
                        {/* Right text */}
                        <div>
                            ...
                            <p className="font-lancelot text-xl text-gray-700 mb-6 leading-relaxed text-justify">
                                ...
                                new things, building solutions, and growing both personally and
                                professionally. Take a look around, and feel free to reach out —
                ...
                <section className="max-w-7xl mx-auto md:px-12 pt-10 md:py-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            {/* Large Project (first featured project) */}
                            {featuredProjects[0] && (
                                <div
                                ...
                                >
                                    ...
                                    <div className="font-lexend_exa absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white p-4 text-center">
                                        ...
                                        <p className="text-sm mt-2">{featuredProjects[0].desc}</p>
                                    </div>
                                </div>
                            )}
                        </div>
